...
import QuickViewModal from './Antmodal'; 

const Product = ({ id, name, price, imageURL, cartQuantity, key, desc, brand ,category}) => {
        ...
        <div className={styles.singleproduct__wraper__image}>
          ...
          <ul className={styles.listActions}>
            ...
            <li className={styles.list}>
              ...
              {/* Pass individual props to QuickViewModal */}
              <QuickViewModal
            ...
            <li className={styles.list}>
              <a
                ...
                onClick={() => addToWishlist({ id, imageURL, name, price })}
              >
                <CiHeart size={22} />
              </a>
            </li>
            <li className={styles.list}>
              <a
                ...
                data-placement="top"
                title="Compare"
                onClick={() => addToCompare({ id, imageURL, name, price })}
              >
